...
void Player::RepopAtGraveyard()
{
    ...
    if (GetZoneId() == 406) // Duel Area
        TeleportTo(1, 1887.9f, 1467.2f, 143.3f, 4.34f);
    else if (GetAreaId() == 2477)  // Vip Island
        TeleportTo(1, -10685.88f, 2437.32f, 11.59f, 3.11f);
    if (ClosestGrave)
    {
...
void Player::UpdateArea(uint32 newArea)
{
    ...
    if (area && area->IsSanctuary() || newArea == 876 || newArea == 2477 || newArea == 3703 || newArea == 406)    // in sanctuary
    {
